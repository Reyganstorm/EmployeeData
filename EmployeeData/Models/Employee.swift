...
class DataManager {
    ...
    public func getRandomPeople(){
    
            for _ in 1...10 {
    
                let randomNameIndex = Int.random(in: 0 ... names.count - 1)
                let randomSurnameIndex = Int.random(in: 0 ... surnames.count - 1)
                let randomEmailIndex = Int.random(in: 0 ... emails.count - 1)
                let randomPhoneNumberIndex = Int.random(in: 0 ... phoneNumbers.count - 1)
